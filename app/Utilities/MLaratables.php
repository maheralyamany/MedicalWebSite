...
use Freshbitsweb\Laratables\ColumnManager;

use Freshbitsweb\Laratables\QueryHandler;
use Freshbitsweb\Laratables\RecordsTransformer;
...
class MLaratables
{
     ...
     *
     * @param \Illuminate\Database\Eloquent\Model to query for
