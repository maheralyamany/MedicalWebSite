 ...
 * @copyleft   Copyleft 2009-2020 SpryMedia Ltd.
 *
...
$.extend( KeyTable.prototype, {
	...
	_updateFixedColumns: function( column )
	{
		...
		if ( settings._oFixedColumns ) {
			var rightCols = settings._oFixedColumns.s.iRightColumns;
			var leftCols = settings.aoColumns.length - settings._oFixedColumns.s.iLeftColumns;

			if (column < rightCols || column >= leftCols) {
