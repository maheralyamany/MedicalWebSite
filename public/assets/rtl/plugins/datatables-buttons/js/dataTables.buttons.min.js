...
null}if(h=a.prefixButtons){a.buttons||(a.buttons=[]);c=0;for(d=h.length;c<d;c++)a.buttons.splice(c,0,h[c]);a.prefixButtons=null}a.extend=f.extend}return a},_popover:function(a,b,c){var d=this.c,g=e.extend({align:"button-right",autoClose:!1,background:!0,backgroundClassName:"dt-button-background",contentClassName:d.dom.collection.className,collectionLayout:"",collectionTitle:"",dropup:!1,fade:400,leftAlignClassName:"dt-button-left",tag:d.dom.collection.tag},c),f=b.node(),h=function(){x(e(".dt-button-collection"),
...
"none");a=e(a).addClass(g.contentClassName).attr("role","menu").appendTo(c);f.attr("aria-expanded","true");f.parents("body")[0]!==r.body&&(f=r.body.lastChild);g.collectionTitle&&c.prepend('<div class="dt-button-collection-title">'+g.collectionTitle+"</div>");w(c.insertAfter(f),g.fade);var d=e(b.table().container()),k=c.css("position");"dt-container"===g.align&&(f=f.parent(),c.css("width",d.width()));if("absolute"===k&&(c.hasClass(g.leftAlignClassName)||c.hasClass(g.rightAlignClassName)||"dt-container"===
g.align)){var n=f.position();c.css({top:n.top+f.outerHeight(),right:n.right});var j=c.outerHeight(),i=d.offset().top+d.height(),t=n.top+f.outerHeight()+j,i=t-i,t=n.top-j,m=d.offset().top,l=n.top-j-5;(i>m-t||g.dropup)&&-l<m&&c.css("top",l);var n=d.offset().right,d=d.width(),d=n+d,k=c.offset().right,s=c.width(),s=k+s,o=f.offset().right,u=f.outerWidth(),u=o+u,o=0;c.hasClass(g.leftAlignClassName)?(o=u-s,n>k+o&&(k=n-(k+o),d-=s+o,o=k>d?o+d:o+k)):(o=n-k,d<s+o&&(k=n-(k+o),d-=s+o,o=k>d?o+d:o+k));c.css("right",
c.position().right+o)}else"absolute"===k?(n=f.position(),c.css({top:n.top+f.outerHeight(),right:n.right}),j=c.outerHeight(),k=f.offset().top,o=0,o=f.offset().right,u=f.outerWidth(),u=o+u,k=c.offset().right,s=a.width(),s=k+s,l=n.top-j-5,i=d.offset().top+d.height(),t=n.top+f.outerHeight()+j,i=t-i,t=n.top-j,m=d.offset().top,(i>m-t||g.dropup)&&-l<m&&c.css("top",l),o="button-left"===g.align?u-s:o-k,c.css("right",c.position().right+o)):(k=c.height()/2,k>e(q).height()/2&&(k=e(q).height()/2),c.css("marginTop",
